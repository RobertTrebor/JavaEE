...
public class Cemetery implements Serializable {
    ...
    public List<Grave> getGraves() {
        System.out.println("Cemetery.java - getGraves()");
        if (graves != null) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Cemetery)) {
            return false;
        }
        Cemetery other = (Cemetery) object;
    ...
    public String toString() {
        return "de.lengsfeld.virtualremembrance.Cemetery[ id=" + id + " ]";
    }
